...
(() => {
  ...
  el.textContent = `
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @keyframes glow { 0%,100%{box-shadow:0 0 20px rgba(125,31,46,0.3)} 50%{box-shadow:0 0 40px rgba(125,31,46,0.6)} }
    ...
    .glass-card:hover {
      ...
      box-shadow: 0 12px 48px rgba(125,31,46,0.12), 0 4px 16px rgba(125,31,46,0.06);
    }
    ...
    .btn-primary {
      ...
      box-shadow: 0 4px 16px rgba(125,31,46,0.25);
      position: relative;
      overflow: hidden;
    }
    ...
    .btn-primary:hover {
      transform: translateY(-2px);
      box-shadow: 0 8px 24px rgba(125,31,46,0.35);
    }
    ...
    .btn-secondary {
      ...
      transition: all 0.2s cubic-bezier(0.16,1,0.3,1);
      box-shadow: 0 2px 8px rgba(125,31,46,0.08);
    }

    .btn-secondary:hover {
      background: #fdf2f4;
      border-color: rgba(125,31,46,0.35);
      transform: translateY(-2px);
      box-shadow: 0 4px 16px rgba(125,31,46,0.12);
    }
    ...
    .input-field {
      ...
      transition: all 0.2s cubic-bezier(0.16,1,0.3,1);
      box-shadow: 0 2px 8px rgba(125,31,46,0.04);
    }

    .input-field:focus {
      border-color: #c4607a;
      background: #fff;
      box-shadow: 0 4px 16px rgba(125,31,46,0.12), 0 0 0 3px rgba(196,96,122,0.1);
    }
    ...
    .tag:hover {
      ...
      box-shadow: 0 4px 12px rgba(125,31,46,0.15);
    }
...
const Icon = {
  home: (active) => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <path d="M2 8L10 2l8 6v9a1 1 0 01-1 1H3a1 1 0 01-1-1V8z"
        stroke={active ? C.bur : C.txt3} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"
        fill={active ? C.bur5 : "none"} />
      <rect x="7" y="12" width="6" height="6" rx="1"
        stroke={active ? C.bur : C.txt3} strokeWidth="1.8" />
    </svg>
  ),
  calendar: (active) => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <rect x="2" y="3.5" width="16" height="14" rx="2.5"
        stroke={active ? C.bur : C.txt3} strokeWidth="1.8" />
  ...
  trends: (active) => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <polyline points="2,15 6,10 9,12 14,6 18,9"
        stroke={active ? C.bur : C.txt3} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ),
  insights: (active) => (
  ...
  chat: (active) => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <path d="M2 4A2 2 0 014 2h12a2 2 0 012 2v9a2 2 0 01-2 2H6l-4 4V4z"
        stroke={active ? C.bur : C.txt3} strokeWidth="1.8" strokeLinejoin="round"
        fill={active ? C.bur5 : "none"} />
    </svg>
  ),
  profile: (active) => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      <path d="M2 18c0-3.5 3.582-6 8-6s8 2.5 8 6"
        stroke={active ? C.bur : C.txt3} strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  ),
  bell: () => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      <path d="M10 2a5.5 5.5 0 015.5 5.5v3.5l2 2.5H2.5l2-2.5V7.5A5.5 5.5 0 0110 2z"
        stroke={C.txt3} strokeWidth="1.6" strokeLinejoin="round" />
  ...
  heart: () => (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      <path d="M9 15.5s-6-3.5-6-8a3.5 3.5 0 017 0 3.5 3.5 0 017 0c0 4.5-6 8-6 8z"
...
function LandingPage({ onGetStarted, onLogin }) {
  const features = [
    ...
    {icon: Icon.calendar(), title: "Cycle Calendar", desc: "Colour-coded phases — menstrual, follicular, ovulation, luteal — all at a glance." },
    {icon: Icon.trends(), title: "Trend Insights", desc: "Track how sleep, stress, mood, and PMS risk shift across your cycle." },
    {icon: Icon.chat(), title: "AI Health Assistant", desc: "Ask anything — symptoms, nutrition, phases — and get empathetic answers." },
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", color: C.txt, overflowX: "hidden", background: C.bur5 }}>
      ...
      <nav className="glass-card" style={{ padding: "16px 40px", display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 100, margin: "0 0 0 0" }}>
      ...
      <section style={{ padding: "100px 40px 120px", textAlign: "center", position: "relative" }}>
        <div style={{ maxWidth: 720, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <div className="scale-in" style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
            <button className="btn-primary" style={{ fontSize: 16, padding: "16px 32px" }} onClick={onGetStarted}>
              Start tracking free {Icon.arrow()}
            </button>
            <button className="btn-secondary" style={{ fontSize: 16, padding: "15px 28px" }} onClick={onLogin}>
              I already have an account
            </button>
          </div>

          <div className="slide-up" style={{ marginTop: 72, display: "flex", justifyContent: "center", gap: 20, perspective: 1200 }}>
            <div className="glass-card" style={{ width: 280, background: "rgba(255,255,255,0.95)", borderRadius: 32, border: `6px solid ${C.txt}`, overflow: "hidden", boxShadow: "0 40px 80px rgba(125,31,46,0.25), 0 0 0 1px rgba(255,255,255,0.5) inset", transform: "rotateY(-7deg) rotateX(3deg)", flexShrink: 0 }}>
              ...
              <div style={{ background: `linear-gradient(135deg, ${C.bur}, ${C.bur2})`, padding: "0 16px 14px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <div style={{ width: 28, height: 28, borderRadius: "50%", background: "rgba(255,255,255,0.25)", backdropFilter: "blur(10px)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 700, color: C.bur5, border: "2px solid rgba(255,255,255,0.3)" }}>P</div>
              </div>
              ...
              <div style={{ background: `linear-gradient(135deg, ${C.bur}, ${C.bur2})`, margin: 12, borderRadius: 18, padding: 16, position: "relative", overflow: "hidden" }}>
                ...
                <div style={{ position: "relative", zIndex: 1 }}>
                  ...
                  <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                    <span style={{ background: "rgba(255,255,255,0.2)", color: C.bur5, padding: "4px 10px", borderRadius: 12, fontSize: 9, fontWeight: 600, backdropFilter: "blur(10px)" }}>28 day cycle</span>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, margin: "0 12px 12px" }}>
                {[["Mar 27", "Next period", C.bur], ["72%", "PMS risk", "#ff6b6b"]].map(([val, lbl, clr]) => (
                  <div key={lbl} className="glass-card" style={{ borderRadius: 12, padding: "10px 12px", background: "#fff" }}>
              ...
              <button style={{ margin: "0 12px 10px", width: "calc(100% - 24px)", background: `linear-gradient(135deg, ${C.bur}, ${C.bur2})`, color: C.bur5, border: "none", borderRadius: 12, padding: "12px", fontSize: 13, fontWeight: 600, cursor: "pointer", boxShadow: "0 4px 12px rgba(125,31,46,0.3)" }}>
                + Log today
              </button>

              <div className="glass-card" style={{ background: "rgba(255,255,255,0.95)", borderTop: `1px solid rgba(125,31,46,0.1)`, display: "flex", justifyContent: "space-around", padding: "10px 0 12px", margin: 0, borderRadius: "0 0 26px 26px" }}>
      ...
      <section style={{ padding: "100px 40px", background: "#fff", position: "relative" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 72 }}>
            ...
            <h2 className="serif" style={{ fontSize: "clamp(32px, 5vw, 48px)", color: C.txt, marginBottom: 16, letterSpacing: "-1px" }}>
              Everything you need to
              <br />
              <span className="gradient-text">understand your body</span>
            </h2>
            <p style={{ fontSize: 16, color: C.txt2, maxWidth: 540, margin: "0 auto" }}>
              Designed with care, backed by science, and built for you.
            </p>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 24 }}>
            {features.map((f, i) => (
              <div key={i} className="glass-card slide-up" style={{ padding: 32, animationDelay: `${i * 0.1}s` }}>
                <div style={{ width: 48, height: 48, borderRadius: 14, background: `linear-gradient(135deg, ${C.bur4}, ${C.bur6})`, display: "flex", alignItems: "center", justifyContent: "center", color: C.bur, marginBottom: 20 }}>
                  {f.icon}
                </div>
      ...
      <section style={{ padding: "100px 40px", background: C.bur5, position: "relative" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 className="serif" style={{ fontSize: "clamp(32px, 5vw, 48px)", color: C.txt, marginBottom: 64, letterSpacing: "-1px" }}>
              ...
              <div key={i} className="glass-card scale-in" style={{ padding: 32, textAlign: "left", animationDelay: `${i * 0.15}s` }}>
                <div style={{ display: "flex", gap: 4, marginBottom: 16 }}>
                  {[...Array(t.rating)].map((_, j) => (
                    <span key={j} style={{ color: "#ffc107", fontSize: 18 }}>★</span>
                  ))}
                </div>
                <p style={{ fontSize: 15, color: C.txt2, lineHeight: 1.7, marginBottom: 20, fontStyle: "italic" }}>"{t.text}"</p>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <div style={{ width: 36, height: 36, borderRadius: "50%", background: `linear-gradient(135deg, ${C.bur3}, ${C.bur4})`, display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontWeight: 700, fontSize: 14 }}>
                    {t.name[0]}
                  </div>
      ...
      <section style={{ padding: "100px 40px 120px", background: `linear-gradient(135deg, ${C.bur}, ${C.bur2})`, textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 640, margin: "0 auto", position: "relative", zIndex: 1 }}>
          <h2 className="serif" style={{ fontSize: "clamp(32px, 5vw, 52px)", color: C.bur5, marginBottom: 24, letterSpacing: "-1px", lineHeight: 1.2 }}>
            Start understanding your body today
          </h2>
          <p style={{ fontSize: 17, color: "rgba(253,242,244,0.85)", lineHeight: 1.7, marginBottom: 40, maxWidth: 520, margin: "0 auto 40px" }}>
            Join thousands of people who trust TrackHER to track their cycle with precision and care.
          </p>
          <button className="btn-primary" style={{ background: "#fff", color: C.bur, fontSize: 17, padding: "18px 36px", boxShadow: "0 8px 32px rgba(0,0,0,0.2)" }} onClick={onGetStarted}>
            Get started for free {Icon.arrow()}
          </button>
          <p style={{ fontSize: 13, color: "rgba(253,242,244,0.6)", marginTop: 20 }}>
      ...
      <footer style={{ background: "#fff", borderTop: `1px solid rgba(125,31,46,0.1)`, padding: "40px 40px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: 13, color: C.txt3, marginTop: 12 }}>
          Made with care for people who menstruate
        </p>
      </footer>
    </div>
  );
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(26,10,13,0.6)", backdropFilter: "blur(8px)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000, padding: 20 }} onClick={onClose}>
      <div className="glass-card scale-in" style={{ maxWidth: 440, width: "100%", padding: 40, position: "relative", background: "rgba(255,255,255,0.98)" }} onClick={(e) => e.stopPropagation()}>
        <button onClick={onClose} style={{ position: "absolute", top: 20, right: 20, background: "none", border: "none", cursor: "pointer", color: C.txt3, padding: 8, display: "flex", alignItems: "center", justifyContent: "center", borderRadius: "50%", transition: "all 0.2s" }}>
          {Icon.close()}
        </button>

        <div style={{ textAlign: "center", marginBottom: 32 }}>
          <span className="serif gradient-text" style={{ fontSize: 32, fontWeight: 600, letterSpacing: "-0.8px" }}>TrackHER</span>
          <h2 style={{ fontSize: 24, fontWeight: 600, color: C.txt, marginTop: 16, marginBottom: 8 }}>
            {formMode === "signup" ? "Create your account" : "Welcome back"}
          </h2>
          <p style={{ fontSize: 14, color: C.txt2 }}>
            {formMode === "signup" ? "Start your cycle tracking journey" : "Sign in to continue"}
          </p>
        </div>

        {error && (
          <div style={{ background: "#fee", border: `1.5px solid #fcc`, borderRadius: 12, padding: 12, marginBottom: 20, fontSize: 13, color: "#c00", fontWeight: 500 }}>
            {error}
          </div>
        )}
        ...
        <button onClick={handleGoogleSignIn} className="btn-secondary" style={{ width: "100%", padding: "13px", fontSize: 14, display: "flex", alignItems: "center", justifyContent: "center", gap: 10 }} disabled={loading}>
        ...
        <p style={{ textAlign: "center", fontSize: 13, color: C.txt2, marginTop: 24 }}>
          ...
          <button onClick={() => setFormMode(formMode === "signup" ? "signin" : "signup")} style={{ background: "none", border: "none", color: C.bur, fontWeight: 600, cursor: "pointer", textDecoration: "underline" }}>
...
function Dashboard() {
  ...
  const [nextPeriod] = useState("Mar 27");
  const [pmsRisk] = useState(72);
    ...
    <div style={{ height: "100vh", display: "flex", flexDirection: "column", background: C.bur5 }}>
      <header className="glass-card" style={{ padding: "16px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", borderRadius: 0, borderBottom: `1px solid rgba(125,31,46,0.1)` }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <button style={{ background: "none", border: "none", cursor: "pointer", padding: 8, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
            {Icon.bell()}
          </button>
      ...
      <main style={{ flex: 1, overflowY: "auto", padding: 32 }}>
        {view === "home" && <HomeView cycleDay={cycleDay} phase={phase} phaseInfo={phaseInfo} nextPeriod={nextPeriod} pmsRisk={pmsRisk} onLogClick={() => setShowLogModal(true)} />}
...
function HomeView({ cycleDay, phase, phaseInfo, nextPeriod, pmsRisk, onLogClick }) {
  return (
    <div style={{ maxWidth: 1200, margin: "0 auto" }}>
      <div className="fade-in" style={{ marginBottom: 32 }}>
        <h1 style={{ fontSize: 32, fontWeight: 700, color: C.txt, marginBottom: 8 }}>Welcome back, Priya</h1>
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 24 }}>
            <div>
              ...
              <div className="serif" style={{ fontSize: 72, color: C.bur5, lineHeight: 1, marginBottom: 12 }}>Day {cycleDay}</div>
              <div style={{ fontSize: 16, color: "rgba(253,242,244,0.85)", marginBottom: 16 }}>{phaseInfo.emoji} {phaseInfo.label} phase</div>
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                <span style={{ background: "rgba(255,255,255,0.2)", backdropFilter: "blur(10px)", color: C.bur5, padding: "8px 16px", borderRadius: 14, fontSize: 12, fontWeight: 600 }}>28 day cycle</span>
                <span style={{ background: C.bur4, color: C.bur, padding: "8px 16px", borderRadius: 14, fontSize: 12, fontWeight: 600 }}>Fertile window</span>
              </div>
            </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 20, marginBottom: 32 }}>
        <div className="glass-card scale-in" style={{ padding: 28 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
            ...
            <div style={{ width: 32, height: 32, borderRadius: "50%", background: `linear-gradient(135deg, ${C.bur4}, ${C.bur6})`, display: "flex", alignItems: "center", justifyContent: "center", color: C.bur, fontSize: 14 }}>
              {Icon.calendar(false)}
            </div>
          </div>
          <div className="serif" style={{ fontSize: 36, fontWeight: 600, color: C.bur, marginBottom: 6 }}>{nextPeriod}</div>
          <p style={{ fontSize: 13, color: C.txt2 }}>In 14 days</p>
        </div>
        ...
        <div className="glass-card scale-in" style={{ padding: 28, animationDelay: "0.1s" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
            ...
            <div style={{ width: 32, height: 32, borderRadius: "50%", background: "linear-gradient(135deg, #ffd93d, #ffaa00)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14 }}>
              ⚠️
            </div>
          </div>
          <div className="serif" style={{ fontSize: 36, fontWeight: 600, color: "#ff6b6b", marginBottom: 6 }}>{pmsRisk}%</div>
        ...
        <div className="glass-card scale-in" style={{ padding: 28, animationDelay: "0.2s" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
            <span style={{ fontSize: 13, fontWeight: 700, color: C.txt3, textTransform: "uppercase", letterSpacing: "1px" }}>Fertile Window</span>
            <div style={{ width: 32, height: 32, borderRadius: "50%", background: "linear-gradient(135deg, #a8e6cf, #56c596)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16 }}>
              ✨
            </div>
          </div>
          <div className="serif" style={{ fontSize: 36, fontWeight: 600, color: "#56c596", marginBottom: 6 }}>Peak</div>
          <p style={{ fontSize: 13, color: C.txt2 }}>Most fertile today</p>
        </div>
      </div>
      ...
      <div className="glass-card slide-up" style={{ padding: 32, background: `linear-gradient(135deg, rgba(125,31,46,0.05), rgba(196,96,122,0.05))` }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
          <div style={{ width: 40, height: 40, borderRadius: 12, background: `linear-gradient(135deg, ${C.bur}, ${C.bur2})`, display: "flex", alignItems: "center", justifyContent: "center", color: C.bur5 }}>
            {Icon.spark()}
          </div>
          <div>
            <h4 style={{ fontSize: 16, fontWeight: 700, color: C.txt, marginBottom: 2 }}>Cycle Insight</h4>
            <p style={{ fontSize: 12, color: C.txt3 }}>Powered by AI</p>
          </div>
        </div>
        <p style={{ fontSize: 15, color: C.txt2, lineHeight: 1.7 }}>
          You're in your ovulation phase — energy and confidence are at their peak. This is a great time for important meetings, social events, and trying new things. Your body is releasing hormones that naturally boost your mood and mental clarity.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto" }}>
      <div className="fade-in" style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 15, color: C.txt2 }}>March 2026</p>
      </div>
      ...
      <div className="glass-card slide-up" style={{ padding: 32 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 8, marginBottom: 12 }}>
          {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map(d => (
            <div key={d} style={{ textAlign: "center", fontSize: 12, fontWeight: 700, color: C.txt3, padding: 12 }}>
              {d}
            </div>
          ))}
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 8 }}>
          {days.map((day, i) => {
            ...
            const phaseInfo = phase ? phaseColors[phase] : null;
            ...
            return (
              <div
                ...
                style={{
                  ...
                  borderRadius: 14,
                  background: day ? (phaseInfo?.bg || "#fff") : "transparent",
                  border: isToday ? `3px solid ${C.bur}` : `1px solid ${day ? "rgba(125,31,46,0.1)" : "transparent"}`,
                  fontSize: 15,
                  fontWeight: isToday ? 700 : 500,
                  color: phaseInfo?.text || C.txt2,
  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto" }}>
      <div className="fade-in" style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 15, color: C.txt2 }}>Track patterns across your cycle</p>
      </div>
...
function InsightsView() {
  const insights = [
    { icon: "💧", title: "Hydration", desc: "You drank 6 glasses of water today. Try to reach 8 for optimal cycle health.", color: "#4dabf7" },
    { icon: "🏃", title: "Exercise", desc: "Great job! You exercised 4 times this week. Keep it up during your follicular phase.", color: "#51cf66" },
    { icon: "😴", title: "Sleep", desc: "Your average sleep is 7.2 hours. Consider adding 30 minutes for better hormone balance.", color: "#845ef7" },
    { icon: "🧘", title: "Stress", desc: "Stress levels are higher this week. Try meditation or gentle yoga to help manage.", color: "#ff6b6b" },
  ];
  ...
  return (
    <div style={{ maxWidth: 1000, margin: "0 auto" }}>
      <div className="fade-in" style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 15, color: C.txt2 }}>Based on your cycle data</p>
      </div>
      ...
      <div style={{ display: "grid", gap: 20 }}>
        {insights.map((item, i) => (
          <div key={i} className="glass-card slide-up" style={{ padding: 28, display: "flex", gap: 20, alignItems: "flex-start", animationDelay: `${i * 0.1}s` }}>
            <div style={{ width: 56, height: 56, borderRadius: 16, background: `${item.color}15`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 28, flexShrink: 0 }}>
              {item.icon}
            </div>
            <div style={{ flex: 1 }}>
      ...
      <div className="glass-card slide-up" style={{ padding: 40, marginTop: 32, background: `linear-gradient(135deg, rgba(125,31,46,0.05), rgba(196,96,122,0.05))` }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
          <div style={{ width: 48, height: 48, borderRadius: 14, background: `linear-gradient(135deg, ${C.bur}, ${C.bur2})`, display: "flex", alignItems: "center", justifyContent: "center", color: C.bur5, fontSize: 24 }}>
            {Icon.star()}
          </div>
          <div>
            <h3 style={{ fontSize: 20, fontWeight: 700, color: C.txt, marginBottom: 4 }}>Your Cycle Score</h3>
            <p style={{ fontSize: 13, color: C.txt3 }}>Based on 28 days of data</p>
          </div>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <div className="serif" style={{ fontSize: 64, fontWeight: 600, color: C.bur }}>8.4</div>
          <div>
            <div style={{ fontSize: 16, color: C.txt2, marginBottom: 8 }}>Excellent cycle health</div>
            <div style={{ width: 200, height: 10, background: "rgba(125,31,46,0.1)", borderRadius: 5, overflow: "hidden" }}>
              <div style={{ width: "84%", height: "100%", background: `linear-gradient(90deg, ${C.bur}, ${C.bur3})`, borderRadius: 5 }} />
            </div>
          </div>
        </div>
      </div>
...
function ChatView() {
  ...
  const handleSend = () => {
    ...
    setInput("");
    setTimeout(() => {
      setMessages(prev => [...prev, { role: "assistant", text: "I'm here to help! While I'm a demo assistant, in the full version I'd provide personalized advice about your cycle, symptoms, and wellness." }]);
    }, 800);
  };
  ...
  return (
    <div style={{ maxWidth: 800, margin: "0 auto", height: "calc(100vh - 200px)", display: "flex", flexDirection: "column" }}>
      <div className="fade-in" style={{ marginBottom: 24 }}>
        <h1 style={{ fontSize: 32, fontWeight: 700, color: C.txt, marginBottom: 8 }}>AI Health Assistant</h1>
        <p style={{ fontSize: 15, color: C.txt2 }}>Ask me anything about your cycle</p>
      </div>

      <div className="glass-card" style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        <div style={{ flex: 1, overflowY: "auto", padding: 28 }}>
          {messages.map((msg, i) => (
            <div key={i} className="fade-in" style={{ display: "flex", gap: 12, marginBottom: 20, animationDelay: `${i * 0.1}s`, alignItems: "flex-start" }}>
              <div style={{ width: 36, height: 36, borderRadius: "50%", background: msg.role === "assistant" ? `linear-gradient(135deg, ${C.bur}, ${C.bur2})` : `linear-gradient(135deg, ${C.bur3}, ${C.bur4})`, display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontWeight: 700, fontSize: 14, flexShrink: 0 }}>
                {msg.role === "assistant" ? "AI" : "U"}
              </div>
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 13, fontWeight: 600, color: C.txt3, marginBottom: 6 }}>{msg.role === "assistant" ? "TrackHER AI" : "You"}</div>
                <div style={{ fontSize: 15, color: C.txt2, lineHeight: 1.6 }}>{msg.text}</div>
              </div>
            </div>
          ))}
        ...
        <div style={{ borderTop: `1px solid rgba(125,31,46,0.1)`, padding: 20 }}>
          <div style={{ display: "flex", gap: 12 }}>
            <input
              type="text"
              className="input-field"
              placeholder="Ask about symptoms, cycle phases, or wellness..."
              value={input}
              onChange={(e) => setInput(e.target.value)}
              onKeyPress={(e) => e.key === "Enter" && handleSend()}
              style={{ flex: 1 }}
            />
            <button onClick={handleSend} className="btn-primary" style={{ padding: "13px 24px" }}>
              {Icon.send()}
            </button>
          </div>
        </div>
  ...
  return (
    <div style={{ maxWidth: 700, margin: "0 auto" }}>
      <div className="fade-in" style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 15, color: C.txt2 }}>Manage your account and settings</p>
      </div>
      ...
      <div className="glass-card slide-up" style={{ padding: 40, textAlign: "center", marginBottom: 24 }}>
        ...
        <h2 style={{ fontSize: 24, fontWeight: 700, color: C.txt, marginBottom: 6 }}>{user?.displayName || "User"}</h2>
      ...
      <div className="glass-card slide-up" style={{ padding: 32, marginBottom: 24 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div>
            <label style={{ display: "block", fontSize: 13, fontWeight: 600, color: C.txt, marginBottom: 8 }}>Average Cycle Length</label>
            <input type="number" className="input-field" defaultValue="28" />
          </div>
          <div>
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(26,10,13,0.6)", backdropFilter: "blur(8px)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000, padding: 20 }} onClick={onClose}>
      <div className="glass-card scale-in" style={{ maxWidth: 600, width: "100%", maxHeight: "90vh", overflowY: "auto", padding: 40, position: "relative", background: "rgba(255,255,255,0.98)" }} onClick={(e) => e.stopPropagation()}>
        <button onClick={onClose} style={{ position: "absolute", top: 20, right: 20, background: "none", border: "none", cursor: "pointer", color: C.txt3, padding: 8 }}>
          {Icon.close()}
        </button>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
          <div>
            ...
            <input type="range" min="1" max="10" value={mood} onChange={(e) => setMood(e.target.value)} style={{ width: "100%", height: 8, borderRadius: 4, background: `linear-gradient(90deg, ${C.bur} 0%, ${C.bur} ${mood * 10}%, rgba(125,31,46,0.1) ${mood * 10}%, rgba(125,31,46,0.1) 100%)`, outline: "none" }} />
          </div>

          <div>
            <label style={{ display: "block", fontSize: 14, fontWeight: 600, color: C.txt, marginBottom: 12 }}>Sleep: {sleep}hrs</label>
            <input type="range" min="1" max="12" value={sleep} onChange={(e) => setSleep(e.target.value)} style={{ width: "100%", height: 8, borderRadius: 4, background: `linear-gradient(90deg, ${C.bur} 0%, ${C.bur} ${(sleep / 12) * 100}%, rgba(125,31,46,0.1) ${(sleep / 12) * 100}%, rgba(125,31,46,0.1) 100%)`, outline: "none" }} />
          </div>

          <div>
            <label style={{ display: "block", fontSize: 14, fontWeight: 600, color: C.txt, marginBottom: 12 }}>Stress: {stress}/10</label>
            <input type="range" min="1" max="10" value={stress} onChange={(e) => setStress(e.target.value)} style={{ width: "100%", height: 8, borderRadius: 4, background: `linear-gradient(90deg, #ff6b6b 0%, #ff6b6b ${stress * 10}%, rgba(255,107,107,0.1) ${stress * 10}%, rgba(255,107,107,0.1) 100%)`, outline: "none" }} />
          </div>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              {symptoms.map(s => (
                <button
                  ...
                  className="tag"
                  style={{
                    background: selectedSymptoms.includes(s) ? C.bur : C.bur6,
                    color: selectedSymptoms.includes(s) ? C.bur5 : C.txt2,
                    border: `1.5px solid ${selectedSymptoms.includes(s) ? C.bur : "rgba(125,31,46,0.2)"}`,
                  }}
                >
                  {s}
                </button>
          ...
          <button className="btn-primary" style={{ width: "100%", justifyContent: "center", marginTop: 12, padding: "16px" }} onClick={onClose}>
            Save Log
          </button>
        </div>
      </div>
